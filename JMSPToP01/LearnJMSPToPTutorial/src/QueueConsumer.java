...
public class QueueConsumer implements MessageListener{
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------Entering Queue Consumer Main()------------------");
		...
		System.out.println("------------------Exiting Queue Consumer Main()------------------");
	}

	@Override
	public void onMessage(Message message) {
		try {
			System.out.println("Incoming Messages to QueueConsumer: " + ((TextMessage)message).getText());
